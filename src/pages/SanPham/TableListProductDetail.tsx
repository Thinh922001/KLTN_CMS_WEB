...
import { IProductDetailGetFromProduct, IProductGet } from '@/Types/Product';
      ...
      <Table>
        ...
        <TableBody>
          {product?.productDetails?.map(
            (item: IProductDetailGetFromProduct) => (
              <TableRow key={item.id}>
                ...
                <TableCell>{getValues(item.variationDetails)}</TableCell>
                ...
                <TableCell className="text-right">
                  <div className="flex gap-2 items-center">
                    ...
                    >
                      <Eye className="text-sky-700" style={{ color: 'blue' }} />
                    </span>
                    <span
                      className="cursor-pointer"
